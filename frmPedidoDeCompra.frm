...
Begin VB.Form frmPedidoDeCompra 
   ...
   ClientTop       =   435
   ClientWidth     =   9495
   Icon            =   "frmPedidoDeCompra.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.CommandButton cmdImprime 
      Height          =   615
      Left            =   8640
      Picture         =   "frmPedidoDeCompra.frx":0442
      Style           =   1  'Graphical
      TabIndex        =   50
      Tag             =   "Imprimir"
      Top             =   480
   ...
   Begin MSDBGrid.DBGrid DBGrid2 
      Bindings        =   "frmPedidoDeCompra.frx":0EC4
      Height          =   1575
      Left            =   240
      OleObjectBlob   =   "frmPedidoDeCompra.frx":0EDA
      TabIndex        =   10
      Top             =   1320
      Width           =   9135
   End
   Begin MSDBCtls.DBCombo cboFornecedor 
      Bindings        =   "frmPedidoDeCompra.frx":2155
      Height          =   315
      Left            =   960
      TabIndex        =   1
      Top             =   360
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSDBCtls.DBCombo cboTanque 
         Bindings        =   "frmPedidoDeCompra.frx":2172
         Height          =   315
         Left            =   5160
         TabIndex        =   16
         Top             =   720
      ...
      Begin MSDBCtls.DBCombo cboProdutos 
         Bindings        =   "frmPedidoDeCompra.frx":2189
         Height          =   315
         Left            =   2400
         TabIndex        =   12
         Top             =   240
      ...
      Begin MSDBGrid.DBGrid DBGrid1 
         Bindings        =   "frmPedidoDeCompra.frx":21A2
         Height          =   1695
         Left            =   120
         OleObjectBlob   =   "frmPedidoDeCompra.frx":21BD
         TabIndex        =   19
         Top             =   1200
         Width           =   8775
      End
   ...
   Begin MSDataListLib.DataCombo cboTurnos 
      Bindings        =   "frmPedidoDeCompra.frx":3254
      Height          =   315
      Left            =   2880
      TabIndex        =   28
      Top             =   6600
...
dbProdutos.Open "Select codigoproduto, codigo, descri, precocompra, precovenda, combustivel, lucrominimo from produtos", db, adOpenKeyset, adLockOptimistic
...
If TemCombustivel = False Then
  If ConfirmaNota(dbNotas.Recordset!CodigoEntrada, txtRecebida.Value, dbTurnos.Recordset!CodigoTurno, cboFormaDePg.Text, txtNrNota.Text) = False Then
      MsgBox "Problema ao confirmar a nota!"
      Exit Sub
  End If
End If
