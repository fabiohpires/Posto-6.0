...
If frmIntegrador.GravarConfiguracoes(txtOrigem.Text, txtDestino.Text, frmIntegrador.txtDataCaixa.Value, frmIntegrador.cboTurno.Text, txtMsde.Text, txtCodigoPosto.Text, txtNomePosto.Text) = True Then
  Unload Me
End If
