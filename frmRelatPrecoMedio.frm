...
Begin VB.Form frmRelatPrecoMedio 
   Caption         =   "Preço Médio"
   ClientHeight    =   5550
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   9600
   Icon            =   "frmRelatPrecoMedio.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   ScaleHeight     =   5550
   ScaleWidth      =   9600
   ...
   End
End
Attribute VB_Name = "frmRelatPrecoMedio"
...
Set CRReport = CRApp.OpenReport("Cadastro de Produtos.rpt")
